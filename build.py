...
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/pixelator/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/pixelator/archive/master.zip", tmp)
    file += "master"
